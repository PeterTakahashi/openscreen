// Vendored for the CLI: @/lib/exporter/muxer was deleted with the web export
// pipeline in the 1.8 line. The multi-window switch compositor still encodes
// its intermediate video renderer-side, so the mediabunny muxer lives on here.
...
import type { ExportConfig } from "@/lib/exporter/types";
